...
public class RegistryRegisterEvent<T> extends RegistryEvent<T> implements Cancelable {

    private boolean isCanceled = false;

    public RegistryRegisterEvent(IRegistry<T> registry, Identifier id, T entry) {
