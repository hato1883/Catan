...
public final class Screens {
     ...
     * This is intended for core/test use only. Throws if already initialized.
     * Package-private to prevent modder access.
     */
    static synchronized void initialize(IScreenManager mgr) {
