...
/**
 * Event fired when a player offers a trade.
 *
 * <h3>See Also:</h3>
 * <ul>
 ...
 * </ul>
 */
public class PlayerTradeOfferEvent extends PlayerTradeEvent implements Cancelable {

    private boolean canceled = false;

    /**
     * Constructs a new PlayerTradeOfferEvent.
     *
     ...
     */
    public PlayerTradeOfferEvent(IGameState gameState, IPlayer recipient, IPlayer sender, Map<IResourceType, Integer> offeredResources, Map<IResourceType, Integer> requestedResources) {
