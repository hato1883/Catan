...
/**
 * Event fired when a game phase is started.
 * Triggered at the very beginning of the phase, before any updates.
 * <h3>Example Usage:</h3>
 * <pre>{@code
 * eventBus.registerListener(PhaseStartEvent.class, event -> {
 *     System.out.println("Phase started: " + event.getPhase().getName());
 * });
 * }</pre>
 * <h3>See Also:</h3>
 * <ul>
 ...
 * </ul>
 */
public class PhaseStartEvent extends PhaseEvent implements Cancelable {

    private boolean canceled = false;

    public PhaseStartEvent(IGameState gameState, IGamePhase phase) {
