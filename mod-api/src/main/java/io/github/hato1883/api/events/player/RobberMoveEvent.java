...
public class RobberMoveEvent extends PlayerActionEvent {
    private final ITile newLocation;
    private final ITile oldLocation;
     ...
     */
    public RobberMoveEvent(IGameState gameState, IPlayer player, ITile newLocation, ITile oldLocation) {
     ...
     *
     * <h3>Defaults:</h3>
     * The new ITile the robber was moved to
     *
     * <h3>Example Usage:</h3>
     * <pre>{@code
     * ITile newLoc = event.getNewLocation();
     * }</pre>
     *
     * <h3>See Also:</h3>
     */
    public ITile getNewLocation () {
        return newLocation;
    }
     ...
     *
     * <h3>Defaults:</h3>
     * The old ITile the robber was moved from
     *
     * <h3>Example Usage:</h3>
     * <pre>{@code
     * ITile oldLoc = event.getOldLocation();
     * }</pre>
     *
     * <h3>See Also:</h3>
     */
    public ITile getOldLocation () {
        return oldLocation;
    }
}
