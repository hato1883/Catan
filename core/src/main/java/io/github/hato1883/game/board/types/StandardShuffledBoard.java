 ...
 * </ul>
 */
public class StandardShuffledBoard extends AbstractBoard {

    /* Default board radius */
    private final static int radius = 3;

    public StandardShuffledBoard(Random rng) {
        Map<CubeCoord, TileAssignment> layout = CatanBoardGenerator.generateDefault(rng);
    ...
    public String getName() {
        return "Settlers of Catan Classic Board (Shuffled)";
    }
